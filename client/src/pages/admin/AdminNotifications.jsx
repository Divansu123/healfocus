...
const TYPE_LABELS = {
  signup: { icon: '🏥', color: 'text-blue-700', bg: 'bg-blue-50 border-blue-200' },
  patient_registered: { icon: '👤', color: 'text-green-700', bg: 'bg-green-50 border-green-200' },
  service: { icon: '🔧', color: 'text-orange-700', bg: 'bg-orange-50 border-orange-200' },
  appt: { icon: '📅', color: 'text-purple-700', bg: 'bg-purple-50 border-purple-200' },
}
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-24 lg:pb-4 lg:px-0 lg:pt-0">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-gray-400">
            ...
            <p className="text-xs mt-1">Hospital signups, new patients & service requests will appear here</p>
          </div>
        ) : (
          <div className="space-y-2">
            {notifications.map(n => {
              const meta = TYPE_LABELS[n.type] || { icon: '🔔', color: 'text-gray-700', bg: '' }
              return (
                <div key={n.id}
