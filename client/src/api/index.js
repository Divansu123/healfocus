...
api.interceptors.response.use(
  ...
  async (err) => {
    ...
    // Login / register / public routes pe refresh logic mat chalao
    const isAuthRoute =
      originalRequest?.url?.includes("/auth/login") ||
      originalRequest?.url?.includes("/auth/register") ||
      originalRequest?.url?.includes("/public/");

    // Sirf protected routes pe token expire hone par refresh try karo
    if (
      ...
      try {
        ...
        // Login page pe ho to redirect mat karo
        if (currentPath !== "/") {
...
export const patientApi = {
  ...
  addBloodPressure: (payload) =>
    api.post("/patient/health/blood-pressure", payload),
  deleteBloodPressure: (id) =>
    api.delete(`/patient/health/blood-pressure/${id}`),
  ...
  addVaccination: (payload) =>
    api.post("/patient/wellness/vaccinations", payload),
  ...
  respondToConsent: (id, payload) =>
    api.patch(`/patient/consent/${id}`, payload),
};
...
export const hospitalApi = {
  ...
  updateAppointment: (id, payload) =>
    api.patch(`/hospital/appointments/${id}`, payload),
  ...
  updatePromotion: (id, payload) =>
    api.put(`/hospital/promotions/${id}`, payload),
...
export const adminApi = {
  ...
  addHospital: (payload) => api.post("/admin/createHospital", payload),
  updateHospitalStatus: (id, payload) =>
    api.patch(`/admin/hospitals/${id}/status`, payload),
  ...
  updateAdmissionStatus: (id, payload) =>
    api.patch(`/admin/admissions/${id}/status`, payload),
  ...
  updateServiceRequest: (id, payload) =>
    api.patch(`/admin/service-requests/${id}`, payload),
